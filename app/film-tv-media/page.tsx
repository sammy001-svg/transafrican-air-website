...
export default function FilmTVMediaPage() {
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">Film, TV & Media Charters</h1>
          <p className="text-lg md:text-xl text-primary-foreground/90 max-w-2xl">
            Production support and equipment transport for film, television, and media productions across Africa.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          {/* Features */}
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-balance">Production Charter Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                  title: "Cast & Crew Transport",
                  description: "Comfortable travel for production teams, talent, and crew members",
                },
                {
                  title: "Equipment Transport",
                  description: "Secure cargo handling for cameras, lighting, and production equipment",
                },
                {
                  title: "Location Scouting",
                  description: "Charter flights to remote locations for production planning",
                },
                {
                  title: "Multi-Stop Itineraries",
                  description: "Complex routing to support multi-location filming schedules",
                },
                {
                  title: "Rapid Deployment",
                  description: "Quick response times for urgent production needs and schedule changes",
                },
                {
                  title: "Catering Services",
                  description: "Onboard meal services and hospitality for production teams",
                },
              ].map((feature, index) => (
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 border border-primary/10">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-primary">Film & Media Production Charter - Get a Quote</h2>
            <p className="text-sm text-foreground/70 mb-6">Our media charter specialists understand production logistics and can tailor solutions for your specific filming needs.</p>
            ...
            <form className="space-y-6">
              ...
              <div className="border-t border-primary/10 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <input 
                    type="text"
                    placeholder="Production Company / Project Name"
                    className="px-4 py-2.5 border-2 border-primary/20 rounded-lg focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition placeholder-foreground/40 text-sm"
                  />
                </div>
              </div>
